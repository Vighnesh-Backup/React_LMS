		...
		<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50">
			...
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				...
				<div className="col-span-full sm:col-span-2 capitalize ">
					...
					<input id="zip" type="file" placeholder="" className="w-full rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-800 focus:dark:ring-violet-600 dark:border-gray-950" />
				</div>
